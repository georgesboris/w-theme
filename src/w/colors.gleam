...
pub type ColorScale {
  ColorScale(
    ...
    text_subtle: colour.Color,
      ...
      shadow: color(101, 99, 109),
    
  ) }
      
      pub fn slate() { ColorScale(
      ...
      shadow: color(96, 100, 108),
    
  ) }
      
      pub fn sage() { ColorScale(
      ...
      shadow: color(95, 101, 99),
    
  ) }
      
      pub fn olive() { ColorScale(
      ...
      shadow: color(96, 101, 95),
    
  ) }
      
      pub fn sand() { ColorScale(
      ...
      shadow: color(99, 99, 94),
    
  ) }
      
      pub fn tomato() { ColorScale(
      ...
      shadow: color(206, 44, 49),
    
  ) }
      
      pub fn ruby() { ColorScale(
      ...
      shadow: color(202, 36, 77),
    
  ) }
      
      pub fn crimson() { ColorScale(
      ...
      shadow: color(203, 29, 99),
    
  ) }
      
      pub fn pink() { ColorScale(
      ...
      shadow: color(194, 41, 138),
    
  ) }
      
      pub fn plum() { ColorScale(
      ...
      shadow: color(129, 69, 181),
    
  ) }
      
      pub fn violet() { ColorScale(
      ...
      shadow: color(101, 80, 185),
    
  ) }
      
      pub fn iris() { ColorScale(
      ...
      shadow: color(87, 83, 198),
    
  ) }
      
      pub fn indigo() { ColorScale(
      ...
      shadow: color(16, 125, 152),
    
  ) }
      
      pub fn teal() { ColorScale(
      ...
      shadow: color(0, 133, 115),
    
  ) }
      
      pub fn jade() { ColorScale(
      ...
      shadow: color(33, 131, 88),
    
  ) }
      
      pub fn grass() { ColorScale(
      ...
      shadow: color(42, 126, 59),
    
  ) }
      
      pub fn brown() { ColorScale(
      ...
      shadow: color(129, 94, 70),
    
  ) }
      
      pub fn bronze() { ColorScale(
      ...
      shadow: color(113, 98, 75),
    
  ) }
      
      pub fn sky() { ColorScale(
      ...
      shadow: color(0, 116, 158),
    
  ) }
      
      pub fn mint() { ColorScale(
      ...
      shadow: color(2, 120, 100),
    
  ) }
      
      pub fn lime() { ColorScale(
      ...
      shadow: color(92, 124, 47),
    
  ) }
      
      pub fn yellow() { ColorScale(
      ...
      shadow: color(158, 108, 0),
    
  ) }
      
      pub fn amber() { ColorScale(
      ...
      shadow: color(204, 78, 0),
    
  ) }
      
      pub fn gray_dark() { ColorScale(
      ...
      pub fn crimson_dark() { ColorScale(
