...
.w-debugger-token { display: flex; justify-content: space-between; gap: 0.5rem; padding: 0.25rem 0.5rem; font-weight: 700; border-top: 1px solid rgb(var(--w-base-detail-subtle)); }
